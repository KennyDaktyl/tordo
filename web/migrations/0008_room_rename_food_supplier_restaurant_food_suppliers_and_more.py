    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, verbose_name='Nazwa pomieszczenia')),
        ...
        migrations.AddField(
            model_name='restaurant',
            name='rooms',
            field=models.ManyToManyField(blank=True, related_name='restaurant_rooms', to='web.room', verbose_name='Pomieszczenia: (many)'),
        ),
    ]
